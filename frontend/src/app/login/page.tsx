    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative">
      ...
      {showBriefing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-xl mx-4 bg-[#0a0a0a] border border-gray-800 rounded-[2.5rem] p-10 shadow-2xl animate-in fade-in zoom-in duration-300">

            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-orange-500 block mb-6">
              System Briefing
            </span>

            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              SkillDash is a platform for posting problems and delivering solutions through
              structured tasks.
            </p>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              <span className="text-white font-bold">Clients</span> use the platform to describe
              a problem, post it as a task, review responses from experts, and work with a
              selected expert to reach a solution. Client progression is based on successful
              task completion and consistent participation on the platform.
            </p>

            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              <span className="text-white font-bold">Experts</span> use the platform to solve
              posted tasks. They complete work, earn EXP, and increase their level and rank
              over time, reflecting their experience and reliability within the system.
            </p>

            <p className="text-gray-500 text-sm leading-relaxed mb-8">
              Your role determines available actions, visibility, and system access.
              You’ll select it during registration.
            </p>

            <button
              onClick={closeBriefing}
              className="w-full py-4 bg-white text-black font-black rounded-2xl hover:bg-orange-500 hover:text-white transition-all active:scale-95 uppercase italic tracking-tight text-sm"
            >
              I Understand
            </button>
          </div>
