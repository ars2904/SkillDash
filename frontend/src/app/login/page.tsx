      ...
      <div className="w-full max-w-md p-8 bg-[#0a0a0a] border border-gray-900 rounded-[2.5rem] shadow-2xl animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          <div className="inline-block px-3 py-1 bg-orange-500/10 border border-orange-500/20 rounded-full mb-4">
             <span className="text-[8px] font-black uppercase tracking-[0.3em] text-orange-500">Secure Node Access</span>
          </div>
          <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none">SkillDash</h1>
          <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest mt-2">Protocol Authorization Required</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="text-[9px] font-black text-gray-500 uppercase tracking-widest ml-1 block mb-1">Link Identifier (Email)</label>
            <input 
              type="email" 
              required
          ...
          <div>
            <label className="text-[9px] font-black text-gray-500 uppercase tracking-widest ml-1 block mb-1">Access Key</label>
            <input 
              type="password" 
              required
              className="w-full p-4 bg-black border border-gray-800 rounded-2xl text-white focus:border-orange-500 outline-none transition-all text-sm placeholder:text-gray-800"
        ...
        <div className="mt-8 pt-6 border-t border-gray-900 text-center">
          <p className="text-gray-600 text-[9px] font-black uppercase tracking-widest">
            Unregistered?{' '}
            <Link href="/register" className="text-orange-500 hover:text-white transition-colors underline underline-offset-4 decoration-gray-800">
              Initialize New Appication
            </Link>
          </p>
        </div>
      </div>
